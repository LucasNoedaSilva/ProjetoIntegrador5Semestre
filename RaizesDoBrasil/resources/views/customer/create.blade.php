...
<head>
    ...
    <title>Novo Cliente - Raízes do Brasil</title>
                        ...
                        <form action="/customer/store" method="POST">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="name" class="form-control border-success" placeholder="Ex: João da Silva" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Telefone/WhatsApp <span class="text-danger">*</span></label>
                                    <input type="text" id="phone" name="phone" class="form-control border-success" placeholder="(00) 00000-0000" required  maxlength="15">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="logradouro" name="street" class="form-control" required>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label fw-semibold">Número <span class="text-danger">*</span></label>
                                    <input type="text" id="numero" name="number" class="form-control" required>
                                </div>
                                
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Complemento</label>
                                    <input type="text" id="complemento" name="complement" class="form-control" placeholder="Apto, Casa 2...">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Bairro <span class="text-danger">*</span></label>
                                    <input type="text" id="bairro" name="neighborhood" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold">Cidade <span class="text-danger">*</span></label>
                                    <input type="text" id="cidade" name="city" class="form-control" readonly required>
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label fw-semibold">UF <span class="text-danger">*</span></label>
                                    <input type="text" id="uf" name="state" class="form-control" readonly required>
                                </div>
                            </div>
