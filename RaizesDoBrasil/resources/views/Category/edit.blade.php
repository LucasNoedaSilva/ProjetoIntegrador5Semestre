...
<head>
    ...
    <title>Editar Categoria - Raízes do Brasil</title>
        ...
        <div class="card shadow-sm" style="max-width: 500px; width: 100%;">
            ...
            <div class="card-body p-4">
                <form action="/category/update/{{$category->id}}" method="POST">
                    ...
                    <!-- Campo Descrição -->
                    <div class="mb-4">
                        <label for="category_describe" class="form-label fw-semibold">Descrição da Categoria</label>
                        <!-- Utilizando textarea para manter a consistência com a criação, preenchendo com o valor existente -->
                        <textarea class="form-control" id="category_describe" name="category_describe" rows="3" required>{{$category->category_describe}}</textarea>
                    </div>
                    
                    <!-- Botões de Ação -->
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-success btn-lg">Salvar Alterações</button>
                        <a href="/category" class="btn btn-outline-secondary">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
