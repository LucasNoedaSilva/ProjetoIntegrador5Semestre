...
<head>
    ...
    <title>Criar Ingrediente - Raízes do Brasil</title>
    ...
    <div class="container flex-grow-1 d-flex justify-content-center align-items-center py-5">
        ...
        <div class="card shadow-sm border-0" style="max-width: 500px; width: 100%;">
            ...
            <div class="card-header bg-success text-white text-center py-3 border-0">
                <h4 class="mb-0 fw-bold"><i class="bi bi-plus-circle me-2"></i>Criar Item</h4>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
                <form action="/ingredient/store" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <!-- Campo obrigatório com required -->
                        <input type="text" class="form-control" id="ingredient_name" name="ingredient_name" placeholder="Ex: Açúcar Mascavo" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="ingredient_quantity" class="form-label fw-semibold text-secondary small text-uppercase">Quantidade</label>
                        <!-- Adicionado min="1" para não aceitar 0 ou números negativos -->
                        <input type="number" class="form-control" id="ingredient_quantity" name="ingredient_quantity" placeholder="Ex: 5" required min="1">
                    </div>
                    
                    <div class="mb-3">
                        <label for="ingredient_due_date" class="form-label fw-semibold text-secondary small text-uppercase">Data de Vencimento</label>
                        <!-- O atributo 'min' bloqueia datas passadas utilizando a data atual do servidor -->
                        <input type="date" class="form-control" id="ingredient_due_date" name="ingredient_due_date" min="{{ date('Y-m-d') }}" required>
                    </div>

                    <div class="mb-4">
                        <label for="category_id" class="form-label fw-semibold text-secondary small text-uppercase">Categoria</label>
                        <!-- Campo obrigatório com required e opção default desabilitada -->
                    ...
                    <div class="mb-5">
                        <label for="ingredient_price" class="form-label fw-semibold text-secondary small text-uppercase">Preço unitário (R$)</label>
                        <div class="input-group">
                            <span class="input-group-text bg-success text-white border-success">R$</span>
                            <!-- Adicionado min="0" para não aceitar números negativos -->
                            <input type="number" step="0.01"  min="0.5" class="form-control border-success" id="ingredient_price" name="ingredient_price" value="0.00" required  >
                        </div>
                    </div>
                    
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-success btn-lg shadow-sm">
                            <i class="bi bi-check2-circle me-1"></i> Criar Item
                        </button>
